  ...
  return ( 
    <div className="p-4 md:p-6 space-y-6">
      {campaigns.map((c, idx) => ( 
        <Card 
          key={idx} 
          className="bg-green-400/20 border border-green-400/30 backdrop-blur-xl shadow-xl shadow-green-900/20 hover:shadow-green-700/50 transition w-full"
        > 
          <CardHeader> 
...
//           </CardContent> 
//           <CardFooter> 
//             <Button className="bg-green-500 hover:bg-green-600 text-green-800" onClick={() => navigate("/app/donate", { state: { campaign: c.name } })} > 
//               Donate 
//             </Button> 
//           </CardFooter> 
//         </Card> 
